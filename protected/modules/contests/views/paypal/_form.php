...
<?php echo CHtml::hiddenField("return", "http://hazclicconmexico.comitefotomx.com/concursar/usrUsuarios/revisarPago")?>
<?php echo CHtml::hiddenField("custom", $custom)?>
<?php echo CHtml::hiddenField("notify_url", "http://hazclicconmexico.comitefotomx.com/concursar/usrUsuarios/iPNPayPal")?>
