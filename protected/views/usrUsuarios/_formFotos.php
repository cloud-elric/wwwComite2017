	...
	<div class="flip-panel front_<?=$pic->txt_pic_number?> <?=$class?>">
		...
		<div class="front-side">
			...
			<div class="row toast-col-row">
				...
				<?php }?>	
					<p class="form-tipo"><?=empty($pic->idCategoriaOriginal)?Yii::t('formFotos', 'noCategory'):CHtml::encode($pic->idCategoriaOriginal->txt_name)?></p>
				</div>

				<div class="col-xs-9 col-sm-8 col-md-8">
					<h3 class="txt_pic_name_label"><?=empty($pic->txt_pic_name)?Yii::t('formFotos', 'noTitle'):CHtml::encode($pic->txt_pic_name)?></h3>
					<p class="form-titulo"><?=empty($pic->txt_pic_desc)?Yii::t('formFotos', 'noDescripcion'):CHtml::encode($pic->txt_pic_desc)?></p>
				</div>
			</div>
			<!-- End .toast-col-row -->
		...
		<div class="back-side back_<?=$pic->txt_pic_number?>">
			...
			<div class="row toast-col-row" id="<?=$pic->txt_pic_number?>">
				...
				?>
					...
					<?php echo $form->dropDownList($pic,'id_category_original',$categorias, array("prompt"=>Yii::t('formFotos', 'selectCategory'), "class"=>"categoria form-control")); ?>
				</div>
				...
				<div class="col-xs-9 col-sm-8 col-md-8">
					...
					<div class="form-group">
						...
						<!-- Input -->
						<?php echo $form->textField($pic,'txt_pic_name',array('class'=>"picName form-control form-control-titulo", "placeholder"=>Yii::t('formFotos', 'titleFoto'))); ?>

					</div>
					<?php echo $form->textArea($pic,'txt_pic_desc', array('class'=>"picDescripcion form-control", "placeholder"=>Yii::t('formFotos', 'descriptionFoto'), "maxlength"=>"500", "data-ide"=>$pic->txt_pic_number)); ?>
	...
	<div class="modal-dialog modal-center">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title"><i class="icon ion-alert-circled"></i> <?=Yii::t('formFotos', 'headerModal')?></h4>
			</div>
			<!-- end / .modal-header -->

			<!-- .modal-body -->
			<div class="modal-body">
				<p><?=Yii::t('formFotos', 'messageModal')?></p>
				<p><?=Yii::t('formFotos', 'messageModalQuestion')?></p>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-red btn-small" data-dismiss="modal"><?=Yii::t('formFotos', 'cancelBtnModal')?></button>
                <button type="button" class="btn btn-green btn-small btn-borrar-foto" onClick="borrarImagen($(this));" data-value="<?=$pic->txt_pic_number?>"><?=Yii::t('formFotos', 'successBtnModal')?></button>
			</div>
			<!-- end / .modal-footer -->
