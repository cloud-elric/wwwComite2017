...
class ConRelContestPayments extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('txt_config_1, txt_config_2, txt_config_3, txt_config_4', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_contest, id_tipo_pago, txt_config_1, txt_config_2, txt_config_3, txt_config_4', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
				...
				'idTipoPago' => array(self::BELONGS_TO, 'PayCatPaymentsTypes', 'id_tipo_pago'),
		);
	}
